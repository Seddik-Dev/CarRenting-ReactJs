    ...
    return (
        <>
            <h5 className='flex flex-wrap w-full'>
                <div className="w-full mx-2 transition-transform transform hover:scale-105">
                    <a
                        href="#"
                        className="block max-w-sm p-6 bg-gradient-to-r from-gray-800 via-orange-600 to-orange-500 border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
                    >
                        <h5 className="mb-2 text-2xl text-center font-bold tracking-tight text-gray-900 dark:text-white">
                            Une Large Gamme de Véhicules
                        </h5>
                        <p className="font-normal text-white text-center dark:text-gray-400">
                            Une flotte variée adaptée à tous vos besoins : citadines, SUV, berlines, ou voitures de luxe.
                        </p>
                    </a>
                </div>

                <div className='w-full mx-2'>
                    <a href="#" class="block max-w-sm p-6 bg-gradient-to-r from-gray-800 via-orange-600 to-orange-500 border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
